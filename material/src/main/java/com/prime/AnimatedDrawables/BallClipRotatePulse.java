...
public class BallClipRotatePulse extends AbstractAnimatedDrawable {
    ...
    public ArrayList<ValueAnimator> onCreateAnimators() {
        ...
        addUpdateListener(scaleAnim, new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                mScale1 = (float) animation.getAnimatedValue();
                postInvalidate();
            }
        });
        ...
        addUpdateListener(scaleAnim2, new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
                mScale2 = (float) animation.getAnimatedValue();
                postInvalidate();
            }
        });
