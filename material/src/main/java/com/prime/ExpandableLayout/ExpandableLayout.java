package com.prime.ExpandableLayout;
 ...
 * <p>
 * I built this because all of the available libraries I tested were missing features or behaving
 * unexpectedly in certain cases (e.g. rotation handling).
 * <p>
 * This library offloads as much work as possible to the parent layout to ensure that the
 * rendering and size calculations behave as expected. This means that even complex features such
 * as LinearLayout's weight tag are properly supported.
 * <p>
 * <p>
 * <p>
 * Also supported are android:duration and defaultExpanded tags, for specifying the duration of the
 * animation and whether the layout should start expanded, respectively. parallaxM can be set
 * to a value between 0 and 1 to control how the child view is translated during the expansion.
 * <p>
 * To trigger the animation, simply grab a reference to the ExpandableLayout from your Java code
 * and and call either of expand(), collapse() or toggle().
 * <p>source https://github.com/cachapa/ExpandableLayout</p>
 *
 * @see FrameLayout
 */
public class ExpandableLayout extends FrameLayout {
    ...
    public ExpandableLayout(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            duration = a.getInt(R.styleable.ExpandableLayout_android_duration, DEFAULT_DURATION);
            expansion = a.getBoolean(R.styleable.ExpandableLayout_defaultExpanded, false) ? 1 : 0;
            orientation = a.getInt(R.styleable.ExpandableLayout_android_orientation, VERTICAL);
            parallax = a.getFloat(R.styleable.ExpandableLayout_parallaxM, 1);
            a.recycle();
