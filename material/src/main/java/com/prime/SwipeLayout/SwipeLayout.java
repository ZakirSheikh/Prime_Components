...
public class SwipeLayout extends FrameLayout {
    ...
    public SwipeLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        setClickToClose(a.getBoolean(R.styleable.SwipeLayout_shouldCloseOnClick, mClickToClose));
        ...
        int ordinal = a.getInt(R.styleable.SwipeLayout_showMode, ShowMode.PullOut.ordinal());
